...
public class DAOHelper extends SQLiteOpenHelper {
    ...
    private final static String DATABASE_NAME = "aviv_item_query.db";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        switch (oldVersion) {
            case 1:
                upgrade1(db, newVersion);
                break;
        }
    }

    private void upgrade1(SQLiteDatabase db, int newVersion) {
        switch (newVersion) {
            case 2:
                db.execSQL(RULE.TABLE_CREATE);
                Log.d(TAG, RULE.TABLE_CREATE);
                break;
        }
    }
    ...
    public interface ITEMS {
        ...
        public static final String[] COLUMNS = {
                BARCODE, NAME, PRICE, WEIGHT, SUPPLIER
        };
    }
