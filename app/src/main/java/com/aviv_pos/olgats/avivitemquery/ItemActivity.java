...
import com.aviv_pos.olgats.avivitemquery.adapters.AbstractExtraModel;
import com.aviv_pos.olgats.avivitemquery.adapters.BooleanExtraModel;
import com.aviv_pos.olgats.avivitemquery.adapters.FloatExtraModel;
import com.aviv_pos.olgats.avivitemquery.adapters.ItemExtraAdapter;
import com.aviv_pos.olgats.avivitemquery.adapters.ItemPromoAdapter;
import com.aviv_pos.olgats.avivitemquery.adapters.ItemPromoModel;
import com.aviv_pos.olgats.avivitemquery.adapters.MapExtraModel;
import com.aviv_pos.olgats.avivitemquery.adapters.PercentFloatExtraModel;
...
// also supports LinearLayoutManager.HORIZONTAL
    ...
    private void loadBackdrop(String code) {
        ...
        if (photo!=null) {
            ...
            Glide.with(this).load(R.drawable.product_icon_256).centerCrop().into(imageView);
    }
}
