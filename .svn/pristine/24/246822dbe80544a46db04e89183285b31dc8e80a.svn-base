package com.aviv_pos.olgats.avivitemquery.acync;

/**
 * Created by olgats on 13/04/2016.
 */
...
import com.aviv_pos.olgats.avivitemquery.ItemSearchCriteria;
import com.aviv_pos.olgats.avivitemquery.MainActivity;
import com.aviv_pos.olgats.avivitemquery.R;
import com.aviv_pos.olgats.avivitemquery.ScannerActivity;
import com.aviv_pos.olgats.avivitemquery.Utilities;
import com.aviv_pos.olgats.avivitemquery.WSConstants;
import com.aviv_pos.olgats.avivitemquery.beans.DataSetPromo;
import com.aviv_pos.olgats.avivitemquery.beans.Item;
import com.aviv_pos.olgats.avivitemquery.beans.ItemImage;
import com.aviv_pos.olgats.avivitemquery.beans.ItemSet;
...
public class ItemSearchTask extends AsyncTask<ItemSearchCriteria, String, ItemSet> {
    ...
    protected ItemSet doInBackground(ItemSearchCriteria... params) {
        ...
        if (criteria != null) {
            ...
            int supplier=criteria.getSupplier();
            try {
                ...
                if (str != null) {
                    ...
                    httpParams.add(new BasicNameValuePair("supplier", Integer.toString(supplier)));
